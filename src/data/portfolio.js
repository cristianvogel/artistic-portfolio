...
export const PROJECTS = [
    ...
    },
    {
        ...
        description: "Collaboration with Anja Behrens. For this portfolio the video opens at 06:29  where the sound design is most relevant to The Mesh Cycle: political questions are carried through voice, transmission residue, and radio-like artefacts, with the score treating unstable broadcast textures as dramaturgical material. Music, sound design, and editing credits.\n\n 😳: stop video manually to return here.",
        chronology: {
    ...
    },
    {
        ...
        description: "A remix composed from source material by Danish electronic music pioneer Else Marie Pade, commissioned for a tribute CD. The work treats Pade's 1961 Etude as an early investigation into audio signal feedback, made with tape machines and filtering in the feedback path. Sound design started with a contemporary networked feedback: sounds from Pade's original were streamed from a Copenhagen studio computer, received through browser after travelling through the web, then routed back into the mixer. The web's latency became the primary delay time, while compression codecs introduced a hard form of subtractive filtering.\n \n The final composition works with these sounds and ehances the emotional and narrative qualities of the entire process.",
        chronology: {
            primary: "09 Mar 2017",
            year: "2017",
            label: "Release",
    ...
    },
    {
        ...
        description: "BornHack 2019 talk on extended listening practice, positioned here as practice based research in a Danish hack conference context. Relevant to networked listening, creative code practice, and how sound plays a part in evolving technologies.",
        chronology: {
            primary: "2019",
            year: "2019",
            label: "Talk",
    ...
    },
    {
        id: "p16",
        sidebarOrder: 2,
        title: "Short presentation of INCLINE at ADCx 2026",
        year: "2026",
        category: "Practice Based Research",
        type: "Conference Talk",
        duration: "starts at 02:14:41",
        focusTags: ["ADCx", "Conference Talk", "INCLINE", "Practice Research"],
        description: "Short presentation of INCLINE at ADCx 2026.",
        chronology: {
            primary: "2026",
            year: "2026",
            label: "Talk",
            iso: "2026",
            source: "https://www.youtube.com/live/lNZ0LEXkqIE?si=Vc7UXfwmL9viLRo4&t=8081"
        },
        media: {
            type: "youtube",
            url: "https://www.youtube.com/embed/lNZ0LEXkqIE",
            startSeconds: 8081,
            caption: "ADCx 2026 / starts at 02:14:41"
        }
    },
    {
        id: "p15",
        ...
        description: "Nye Veje artistic research scholarship from the Danish Composers Society, awarded for a deep dive into data-driven music and data sonification. The research asked how sound can use data models as raw material, how abstract data structures can generate meanings, and how listeners can use those meanings. One result was Story In Blood, an audiovisual work made from over 600 blood tests taken during the period Sune Petersen (the visual artist) was in hospital. The work uses an individual's medical story as the basis for a powerful and attention grabbing piece of data-driven music and video.",
        chronology: {
            primary: "25 Jan 2023",
            year: "2023",
            label: "Grant",
    ...
    },
    {
        ...
        bottomMedia: {
            type: "vimeo",
            id: "708497704",
            caption: "further_in full performance / vimeo"
        },
        loops: [
            {
    ...
    },
    {
        ...
        description: "Composition for dance, focused here is the use of an early form of text-to-speech as a generative scoring material. The work used realtime speech synthesis typed into laptops as aspects of the score, bringing synthetic voices, fictionalised news stories, and choreographic timing into the same compositional field.",
        chronology: {
            primary: "06 Mar 2008",
            year: "2008",
            label: "Website",
        ...
        media: {
            type: "none",
            caption: "production image / Cie Gilles Jobin"
        }
    }
];
...
export const THESIS_TAGS_BY_PROJECT = {
    ...
    p14: [
        "talk",
        "listening practice for non-musicians",
        "network culture",
